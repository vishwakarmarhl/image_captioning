Referenced from:  https://github.com/DeepRNN/image_captioning
...
```shell
python main.py --phase=test --model_file=models/10999.npy --beam_size=3
```
...
I have added another partially trained network (epoch 6 on a GPU Google cloud instance) downloadable [here](https://1drv.ms/u/s!AqHh2eQCcWu8g8Mc1iwoinmS9ghatg) 

Here are some captions generated by this model:
![examples](test/results/lap5_result.jpg)
